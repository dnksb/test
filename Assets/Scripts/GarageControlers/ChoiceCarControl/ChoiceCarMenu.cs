...
public class ChoiceCarMenu : MonoBehaviour
{
    ...
    public void DeleteCar()
    {
        ...
        DataBase.ExecuteQueryWithoutAnswer($"DELETE FROM '{ChoiceCarMenu.Nickname}' WHERE id_car = '{id_car_text}'");
        ...
        var tmp1 = DataBase.ExecuteQueryWithAnswer(
            $"UPDATE players SET level = {maney + 400} WHERE nickname = '{ChoiceCarMenu.Nickname}'");
    }
